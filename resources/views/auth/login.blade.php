...
<head>
    ...
    <title>Police Escort | Backoffice</title>
    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="../../index2.html" class="h1"><b>Police Escort</b> /Backend</a>
            </div>
            <div class="card-body">
                <p class="login-box-msg">Sign in to start your session {{ session('status') }}</p>
